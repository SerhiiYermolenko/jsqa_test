...
let types = [];
types.push(stringVar, booleanVar, undefinedVar)
let counter = 0;
for(let key in types)
{
	if(	typeof key === 'number' || typeof key === 'string' ||
		typeof key === 'undefined' || typeof key === 'null' ||
		typeof key === 'boolean' || typeof key === 'object' ||
		typeof key === 'symbol' || typeof key === 'function')
		{
			counter++;
		}
